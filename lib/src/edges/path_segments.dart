...
///
/// Uses a single [controlPoint] to define the curve shape. Used for rounded
/// corners in step/smoothstep connections and simple curved transitions.
...
class CubicSegment extends PathSegment {
  ...
  List<Rect> getHitTestRects(Offset start, double tolerance) {
    ...
    // Maximum perpendicular expansion allowed (same constraint as
    // StraightSegment)
    ...
    // For very small curves (both dimensions within perpendicular limit),
    // single rectangle
  ...
  /// Calculates maximum perpendicular deviation of control points from chord.
  ...
  @override
  String toString() =>
      'CubicSegment(cp1: $controlPoint1, cp2: $controlPoint2, end: $end, '
      'curvature: $curvature)';
}
